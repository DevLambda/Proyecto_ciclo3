        ...
        <div>
            ...
            <section className="contenedorFormVentas" id="container">
                ...
                <form ref={form} onSubmit={submitForm} name="form_ventas" id="form_ventas">
                    <fieldset ClassName="datosCliente1">
                    ...
                    <hr/>
                    <fieldset ClassName="datosVenta1">
                        ...
                        <label id="labelVendedor">Vendedor
                ...
                <button type="submit" className="btn_registrar_venta"><i className="fas fa-edit"></i>Registrar venta</button>  
            </form>
        </section>
    <Footer />
</div>
